...
const siteOrigin = String(runtimeConfig.public.origin || 'https://type.ennuyez-vous.xyz').replace(/\/$/, '')
...
const robotsContent = $computed(() => {
  ...
  const isDevelopmentHost = ['dev.type.ennuyez-vous.xyz', 'localhost', '127.0.0.1'].includes(hostname)
