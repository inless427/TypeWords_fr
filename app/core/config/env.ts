...
// 单词发音兜底 API：英语 youdao；法语改用 Google TTS（自由可访问，无需 key）
export const PronunciationApi = 'https://dict.youdao.com/dictvoice?audio='
export const FrenchPronunciationApi = 'https://translate.googleapis.com/translate_tts?ie=UTF-8&client=tw-ob&tl=fr&q='
